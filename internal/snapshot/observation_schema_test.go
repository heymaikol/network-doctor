...
var observationValidationPolicy = map[string]string{
	...
	"Route.Gateway":               "structural: optional IP; cross-family next hops are possible",
	"Route.Source":                "structural: optional IP; no platform-specific address selection rules",
	"Route.Prefix":                "structural: optional CIDR; support pseudonyms need not contain the destination",
